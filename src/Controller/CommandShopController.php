...
class CommandShopController extends AbstractController
{
    ...
    public function index(CommandShopRepository $commandShopRepository): Response
    {
        ...
        return $this->render('command_shop/index.html.twig', [
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('command_shop_index', [], Response::HTTP_SEE_OTHER);
        }

        return $this->renderForm('command_shop/new.html.twig', [
    ...
    {
        return $this->render('command_shop/show.html.twig', [
            'command_shop' => $commandShop,
        ]);
    }
    ...
    public function edit(Request $request, CommandShop $commandShop, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->renderForm('command_shop/edit.html.twig', [
            'command_shop' => $commandShop,
            'form' => $form,
        ]);
    }
